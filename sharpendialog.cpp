...
SharpenDialog::SharpenDialog(QImage inputImage)
{
    srcImage = inputImage;
...
void SharpenDialog::iniUI()
{
    ...
    dstLabel = new QLabel(tr("Sharpen"));
...
void SharpenDialog::setImage(QImage image, QLabel *label)
{
    QPixmap pix;
    pix.fromImage(image);
    label->setPixmap(pix);
...
void SharpenDialog::Sharpen(QImage &src_image, QImage &dst_image)
{
    dst_image = src_image;
    /*Sharpen kernel*/
