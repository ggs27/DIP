...
ACEDialog::ACEDialog(QImage inputImage)
{
    ...
    /*
     *The image has three channels: R, G, B, which represent the three colors of red, green, and blue respectively.
     * The RGB color mode is a color standard in the industry.
     * It obtains various colors by changing the three color channels of red (R), green (G), and blue (B) and superimposing them with each other.
     * This standard includes almost all the colors that human vision can perceive, and is one of the most widely used color systems.
     */
...
void ACEDialog::iniUI()
{
    ...
    /*
     * The core of this algorithm is the calculation of the high-frequency part gain coefficient (also called CG).
     * One method is to set this coefficient as a constant,
     * and the second method is to express the gain as a quantity related to the variance.
     */
...
//Set image for adaptive Contrast Enhancement algorithm
...
//Using adaptive Contrast Enhancement algorithm to update Image
