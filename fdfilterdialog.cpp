...
/*
 * Image frequency domain filtering, mainly through the frequency (spatial rate of change) transformation of the image matrix element values,
 * the underlying principle is Fourier transform and series.
 */
...
//Set image for FDFilter algorithm
...
//Using FDFilter algorithm to update Image
